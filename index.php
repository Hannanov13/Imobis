...
<div class="registration-form">
    <h2><span class="badge bg-dark">Регистрация на сервисе</span></h2>
    <form method="POST">
        <div class="mb-3">
        ...
        <div class="d-grid gap-2">
            <button class="btn btn-danger " type="button" id="reg">Регистрация</button>
        </div>

        <div ><span id="err"></span></div>


        <p><a href="login.php" class="link-dark">Вход</a></p>
    </form>
